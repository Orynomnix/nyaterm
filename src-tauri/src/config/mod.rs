...
pub use settings::{
    ...
    GeneralSettings, InteractionSettings, KeywordHighlightRule, PortableUpdateDownloadSource,
    ProxySettings, RiskLevel, SearchEngine, SearchSettings, SecuritySettings, TerminalColorsConfig,
